...
namespace Net.UI
{
    ...
    public partial class TabGroup
    {
        ...
        public new IList<Widget> Children
        {
            get => (IList<Widget>)GetValue(ChildrenProperty);
        ...
        public static readonly BindableProperty ChildrenProperty = BindableProperty.Create(
            ...
            returnType: typeof(IList<Widget>),
            declaringType: typeof(TabGroup),
            defaultValue: null,
            propertyChanged: (bindable, oldVal, newVal) =>
            {
                if (bindable is TabGroup page)
                {
                    if (oldVal is IList<Widget> views)
                    {
                        foreach (var item in views)
                            item.PropertyChanged -= page.Child_PropertyChanged;
                    }

                    if (newVal is ObservableCollection<Widget>)
                    {
                        (newVal as ObservableCollection<Widget>).CollectionChanged += page.TabGroup_CollectionChanged;
                    }
                    if (oldVal is ObservableCollection<Widget>)
                    {
                        (oldVal as ObservableCollection<Widget>).CollectionChanged -= page.TabGroup_CollectionChanged;
                    }
                    page.UpdateChildren();
                }
            });
        ...
        private void Child_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            var monitoredNames = new[]
            {
                nameof(Widget.Title),
                nameof(Widget.Icon),
                nameof(Widget.ShowTabCommand),
                nameof(Widget.SelectedIcon),
                nameof(Widget.IsVisibleAsTab)
            };
            ...
            if (e.PropertyName == nameof(Widget.IsVisibleAsTab))
            {
                UpdateActivePage();
            }
        }
        ...
        {
            //Show
            Children[SelectedIndex].CancelAnimations();
        ...
        {
            oldChild.CancelAnimations();
            newChild.CancelAnimations();
        ...
        {
            var oI = Children.IndexOf((Widget)oldChild);
        ...
        new readonly Command<Widget> ShowTabCommand = new Command<Widget>(view =>
        {
