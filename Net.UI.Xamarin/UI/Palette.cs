...
namespace Net.UI
{
    public static class Palette
    {
        ...
        public static Color Black { get; } = Color.FromHex("#000");
        public static Color White { get; } = Color.FromHex("#FFF");
        public static Color Transparent { get; } = Color.FromHex("#00000000");
        public static Color LightGray { get; } = Color.FromHex("#D3D3D3");
        public static Color Silver { get; } = Color.FromHex("#C0C0C0");
        public static Color DarkGray { get; } = Color.FromHex("#A9A9A9");
        public static Color Gray { get; } = Color.FromHex("#808080");
        public static Color DimGray { get; } = Color.FromHex("#696969");
